...
const FormPut = ({ putValue, onClose }: PutFormTransactionsProps) => {
  ...
  //   >
  //     <div className=" w-full max-w-lg h-[80vh] overflow-y-auto bg-white rounded-xl relative">
  //       <div className="flex items-center justify-between sticky top-0 bg-white p-6">
